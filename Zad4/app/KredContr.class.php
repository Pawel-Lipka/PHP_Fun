...
require_once $config->root_path."/app/kredForm.class.php";
require_once $config->root_path."/libs/Messages/Messages.class.php";
require_once $config->root_path."/app/KredResults.class.php";
use Smarty\Smarty;
...
//--------- methods ---------
    ...
    public function generate_View(){
        ...
        $smarty->display($config->root_path.'/app/kred_view.tpl');
